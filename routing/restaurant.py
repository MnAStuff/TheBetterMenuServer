...
def get_all_restaurants():
    restaurants = Restaurant.query.filter_by(owner_id=current_user.id).all_or_404()
...
def create_restaurant():
    ...
    restaurant = Restaurant(body.get('name'), body.get('address'), body.get('description'), current_user.id)
